...
class ChartWidget(QWidget):
    def __init__(self) -> None:
        ...
        self.figure = Figure(figsize=(4, 3), facecolor="#161616")
    ...
    def plot_radar(
        ...
        axis.set_facecolor("#1E1E1E")
        self.figure.patch.set_facecolor("#161616")
    ...
    def _style_axis(self, axis) -> None:
        ...
        axis.yaxis.label.set_color("#AAAAAA")
        axis.xaxis.label.set_color("#AAAAAA")
        axis.title.set_color("#F0F0F0")
        axis.grid(color="#2A2A2A", alpha=0.6)
